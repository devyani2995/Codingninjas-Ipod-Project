...
const Ipod = (props) => {
	...
	// For changing the Ipod Bottom Container Theme Color
	...
	// For changing the Ipod Top Container Theme Color
	...
	// For changing the Ipod Display Container Theme Color
	...
	// For changing the Ipod Theme Shadow
	const themeIpod = () => {
		if (theme.themeIndex === 0) {
			return {
